	...
	function changeROETimeFunction() { 
		  ...
		  if(roeDateSelection == "Dubai"){
			...
			for (i = 0; i < x00.length; i++) {
			  ...
			  x00[i].innerHTML = "06 am";
			  x01[i].innerHTML = "07 am";
			  x02[i].innerHTML = "08 am";
			  x03[i].innerHTML = "09 am";
			  x04[i].innerHTML = "10 am";
			  x05[i].innerHTML = "11 am";
			  x06[i].innerHTML = "12 am";
			  x07[i].innerHTML = "01 pm";
			  x08[i].innerHTML = "02 pm";
			  x09[i].innerHTML = "03 pm";
			  x10[i].innerHTML = "04 pm";
			  x11[i].innerHTML = "05 pm";
			  x12[i].innerHTML = "06 pm";
			  x13[i].innerHTML = "07 pm";
			  x14[i].innerHTML = "08 pm";
			  x15[i].innerHTML = "09 pm";
			  x16[i].innerHTML = "10 pm";
			  x17[i].innerHTML = "11 pm";
			  x18[i].innerHTML = "12 pm";
			  x19[i].innerHTML = "01 am";
			  x20[i].innerHTML = "02 am";
			  x21[i].innerHTML = "03 am";
			  x22[i].innerHTML = "04 am";
			  x23[i].innerHTML = "05 am";
			}
		  }
...
<tr><td> 01 <b>(<span class="t01"></span>)</b> </td><td> 09 <b>(<span class="t09"></span>)</b> </td><td> 17 <b>(<span class="t17"></span>)</b> </td><td> - <i>Building + VIP Points</i></td></tr>
